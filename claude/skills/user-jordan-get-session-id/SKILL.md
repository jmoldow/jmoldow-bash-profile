...
description: Determines the current Claude Code session ID (UUID). Use when the user needs to resume a session with `claude --resume`, or before writing temp files to `/tmp/claude/<session-id>/`.
---
